...
d) Se han reconocido las posibilidades de procesamiento en los entornos cliente y
servidor.
...
c) Se ha configurado en el lenguaje de guiones la conexión para el acceso al sistema
gestor de base de datos.
cve: BOE-A-2009-18355
BOLETÍN OFICIAL DEL ESTADO
Núm. 278 Miércoles 18 de noviembre de 2009 Sec. I.   Pág. 97888
...
• Del propio servidor de aplicaciones: tiempos de respuesta, conexiones
concurrentes…
...
- Licencias de uso.
- Requerimientos de funcionamiento: servidor web, lenguaje de script, sistema gestor de
bases de datos,…
- Instalación.
...
- Gestión de errores.
- Mecanismos de introducción de información: formularios. Procesamiento de datos
...
datos.
- Conexión a bases de datos. Acceso mediante funciones nativas. Acceso mediante ODBC
